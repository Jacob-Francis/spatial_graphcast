...
binary_file = CustomCSSS.load_binary_file('/home/jjf817/macomp001/jjf817/Jacob_Gregor_3_degree_model_code/Code_0/smoothing_data/3_deg/')
area_size_expanded = CustomCSSS.load_area_size('/home/jjf817/macomp001/jjf817/Jacob_Gregor_3_degree_model_code/Code_0/smoothing_data/3_deg/area_size.npy')

# assert 0

# compute loss using custom function
# loss = loss_func.apply(y_c.view, target_c, area_size_expanded, binary_file)
y_c = torch.randn(batch_size, lon_shape, dtype=torch.float64, requires_grad=True)
target_c = torch.randn(batch_size, lon_shape, dtype=torch.float64)
